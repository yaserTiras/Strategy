...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RaycastHit2D_t210878DAEBC96C1F69DF9883C454758724A106A4  Physics2D_GetRayIntersection_m64AD7C20DBE590CF7D435869FEA8C5FAAB2AE22B (Ray_t2E9E67CC8B03EE6ED2BBF3D2C9C96DDF70E1D5E6  ___ray0, const RuntimeMethod* method)
{
	...
	memset((&V_1), 0, sizeof(V_1));
	{
		...
		RaycastHit2D_t210878DAEBC96C1F69DF9883C454758724A106A4  L_2;
		L_2 = PhysicsScene2D_GetRayIntersection_mDB017A07453F6500D8DC97E102187DCBB8634928((PhysicsScene2D_tB68D090292BC3369F94CBB7496FE96EB00853E48 *)(&V_0), L_1, (std::numeric_limits<float>::infinity()), ((int32_t)-5), /*hidden argument*/NULL);
		V_1 = L_2;
		goto IL_0019;
	}
...
IL_0019:
	{
		RaycastHit2D_t210878DAEBC96C1F69DF9883C454758724A106A4  L_3 = V_1;
		return L_3;
	}
}
